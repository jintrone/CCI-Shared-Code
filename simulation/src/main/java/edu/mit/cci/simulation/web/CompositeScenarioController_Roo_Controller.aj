...
privileged aspect CompositeScenarioController_Roo_Controller {
    
    @RequestMapping(method = RequestMethod.POST)
    public String CompositeScenarioController.create(@Valid CompositeScenario compositeScenario, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
    ...
    public String CompositeScenarioController.createForm(Model model) {
    ...
    public String CompositeScenarioController.show(@PathVariable("id") Long id, Model model) {
        addDateTimeFormatPatterns(model);
    ...
    public String CompositeScenarioController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model model) {
    ...
    public String CompositeScenarioController.update(@Valid CompositeScenario compositeScenario, BindingResult result, Model model, HttpServletRequest request) {
        if (result.hasErrors()) {
            model.addAttribute("compositeScenario", compositeScenario);
            addDateTimeFormatPatterns(model);
    ...
    public String CompositeScenarioController.updateForm(@PathVariable("id") Long id, Model model) {
        model.addAttribute("compositeScenario", CompositeScenario.findCompositeScenario(id));
        addDateTimeFormatPatterns(model);
        return "compositescenarios/update";
    }
    ...
    public String CompositeScenarioController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model model) {
    ...
    public Collection<DefaultSimulation> CompositeScenarioController.populateDefaultSimulations() {
        return DefaultSimulation.findAllDefaultSimulations();
    }
    
    @ModelAttribute("scenariolists")
    public Collection<ScenarioList> CompositeScenarioController.populateScenarioLists() {
        return ScenarioList.findAllScenarioLists();
    }
    
    @ModelAttribute("steps")
    public Collection<Step> CompositeScenarioController.populateSteps() {
        return Step.findAllSteps();
    }
    
    @ModelAttribute("tuples")
    public Collection<Tuple> CompositeScenarioController.populateTuples() {
        return Tuple.findAllTuples();
    }
    
    void CompositeScenarioController.addDateTimeFormatPatterns(Model model) {
        model.addAttribute("compositeScenario_created_date_format", DateTimeFormat.patternForStyle("S-", LocaleContextHolder.getLocale()));
    }
    
    String CompositeScenarioController.encodeUrlPathSegment(String pathSegment, HttpServletRequest request) {
